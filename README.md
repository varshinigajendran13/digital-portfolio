...
<body>
    ...
    <section id="about">
        <div class="section-content">
            <h2>About Me</h2>
            <p>Motivated Computer Science student with expertise in <B>Python</B> and <B>JAVA</B> development, including <B>HTML</B>, and <B>CSS</B>. Looking for an opportunity to develop user-friendly, scalable web applications and enhance my coding skills.</p>
    ...
    <section id="projects">
        <div class="section-content">
            <h2>Projects</h2>
            <ul>
                <li><a href="#">Digital Porfolio</a></li> 
